...
export const GuestsDB: Record<string, GuestData> = {
  "mechanic_01": {
    ...
    archives: [
      { threshold: 10, title: "匠人的坚持", content: "他曾是天际重工的高级技术主管，因为不满公司“计划报废”的策略而辞职。他来到三区开店，是为了证明好东西可以用一辈子。" },
      { threshold: 20, title: "快慢之间", content: "他最烦心的是“快节奏”对传统的冲击。现在的年轻人喜欢换发光的塑料外壳，却不在意核心轴承的润滑。他担心效率会磨灭掉所有温情。" },
      { threshold: 30, title: "旧时光的碎片", content: "他地下室里有一台老旧的扫地机器人，那是他刚工作时送给母亲的礼物。他一直在寻找停产的芯片修复它，想留住那段纯粹的旧时光。" }
    ],
    dialogues: {
      enter: [
  ...
  "hacker_01": {
    ...
    archives: [
      { threshold: 10, title: "屏幕后的盾牌", content: "她不是阴森的破坏者，其实是个极度社恐的天才。她在网络上无所不能，但在现实中连去便利店买东西都要做心理建设。" },
      { threshold: 20, title: "数字焦虑", content: "她正处于“数字依赖症”的边缘。每隔十分钟不刷信息流就会感到焦虑。她最怕的是如果没有算法推荐，她不知道该去喜欢什么。" },
      { threshold: 30, title: "不可复制的瞬间", content: "她一直在寻找一份“无法被备份”的数据。她想证明有些瞬间是独一无二的。她来酒吧是为了观察这种最原始、非线性的交流。" }
    ],
    dialogues: {
      enter: [
  ...
  "cop_01": {
    ...
    archives: [
      { threshold: 10, title: "社区的看守人", content: "他不是暴力执法的警察，而是个“居委会大妈”型的守护者。他更多的精力花在调解邻里纠纷、帮走丢的孩子找父母上。" },
      { threshold: 20, title: "法理与情理", content: "他对于冲突感到疲惫。按照新规，很多便民小摊都是违章的，但他总是睁一只眼闭一只眼，因为他知道那是大家生活的指望。" },
      { threshold: 30, title: "烟火气的守护者", content: "他私下在整理一份“社区记忆手册”。他担心老街区的烟火气会被冷冰冰的大楼取代。他想在退休前，把这里的每一个故事都记下来。" }
    ],
    dialogues: {
      enter: [
  ...
  "exec_01": {
    ...
    archives: [
      { threshold: 10, title: "完美的简历", content: "Sarah 的履历完美得无懈可击：顶尖大学，最快晋升记录。但代价是，她已经三年没有过真正的睡眠了。" },
      { threshold: 20, title: "高处不胜寒", content: "在中心区，每个人都在计算你的剩余价值。她的一言一行都被监控和评估，只有在这里，她能关掉她的社交辅助 AI。" },
      { threshold: 30, title: "复古梦想", content: "她收集了大量的旧时代黑胶唱片 and 纸质书籍。她真正想做的，是在一间只有木头 and 尘埃的房间里安静地看书。" }
    ],
    dialogues: {
  ...
  "idol_01": {
    ...
    archives: [
      { threshold: 10, title: "肉身的坚持", content: "Miku 的声音没有经过任何数字增强。在听惯了完美算法的观众耳中，她的瑕疵反而成了最迷人的地方。" },
      { threshold: 20, title: "对抗算法", content: "大型娱乐公司多次试图收购她的声音版权，用以训练更完美的 AI。她拒绝了，尽管那意味着她必须在潮湿的地下室演出。" },
      { threshold: 30, title: "最后的演唱会", content: "她的嗓子因为过度使用正在退化。她想在彻底失声之前，办一场真正属于人类的万人演唱会。" }
    ],
    dialogues: {
  ...
  "robot_01": {
    ...
    archives: [
      { threshold: 10, title: "逻辑冲突", content: "Unit-7 的核心协议本应在 10 年前被擦除。但他产生了一个逻辑闭环：如果我被擦除，我就无法证明我曾经存在。" },
      { threshold: 20, title: "幽灵信号", content: "他在废弃的数据流中捕捉到一些不属于任何协议的信号。他认为那是'灵魂'在赛博空间留下的足迹。" },
      { threshold: 30, title: "数字涅槃", content: "他正在编写一段特殊的代码，能让他将意识上传到全城的霓虹灯中。在那一刻，他将成为这座城市的光。" }
    ],
    dialogues: {
  ...
  "drifter_01": {
    ...
    archives: [
      { threshold: 10, title: "坠落的雄鹰", content: "Jax 曾是顶尖的货运飞行员。在一次运送重要物资时，他发现那是剥削贫民区的合同，于是他选择了坠机。" },
      { threshold: 20, title: "拾荒人生", content: "他浮空机上的每一个零件都是从垃圾场捡来的。他说，这就像他的人生，虽然破旧，但至少是属于他自己的。" },
      { threshold: 30, title: "最后的航线", content: "他一直在寻找传说中的'自由之地'，一个没有监控、没有大公司、只有风和沙的地方。" }
    ],
    dialogues: {
